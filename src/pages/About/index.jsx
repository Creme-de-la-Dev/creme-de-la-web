...
function About() {
  ...
  return (
    <div>
      <section className="header xl:h-screen p-16 lg:p-32">
        <div className="xl:inline-flex flex-column justify-between w-full">
            <div className="flex-column max-w-4xl h-full justify-between">
                ...
                <h2 class="mt-5 text-cdln-blue-50 text-lg lg:text-3xl animate__animated animate__fadeIn">  
