      ...
      <section className="header min-h-screen p-16 lg:p-28">
        <div className="xl:inline-flex flex-column justify-between w-full">
            <div className="flex-column max-w-4xl h-full justify-between">
                <h1 className="text-cdln-blue-100 text-4xl lg:text-8xl font-bold animate__animated animate__bounceInDown">
                    Sobre Nós
                </h1>
                <h2 className="mt-5 text-cdln-blue-50 text-lg lg:text-2xl animate__animated animate__fadeIn">  
