    ...
    <div>
      ...
      <section className="bg-cdln-blue-900" id="main-section">
            ...
            <div className="flex flex-col sm:flex-row justify-center sm:justify-evenly p-4 sm:p-0">
              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="pt-5 self-center animate__animated animate__fadeIn">
                  <button className="bg-cdln-blue-50 hover:bg-cdln-blue-100 text-cdln-blue-800 font-bold py-4 px-6 border-2 border-cdln-blue-400 rounded-3xl shadow-lg flex flex-row items-center gap-3 text-2xl" href="/">
        ...
        <div class="pt-44">
          <div className="shows">
            <div className="flex flex-col sm:flex-row justify-center sm:justify-evenly p-4 sm:p-0">
            <img className="w-64 md:w-80 lg:w-96 self-center sm:hidden" src={Shows} alt="Shows" />
              <div className="flex flex-col gap-7">
                <h1 className="font-semibold text-5xl w-full md:text-7xl lg:text-8xl text-cdln-blue-100 text-center">Séries Aclamadas</h1>
                <h2 className="lg:text-3xl md:text-2xl text-lg justify-center text-slate-400 font-light text-center">
                Webshows do grupo <strong>Creme de la Nage</strong> já estão disponíveis na plataforma, sendo estes <strong>Luan’s Revolution (2015)</strong>,
                <br/>
                <strong>Creme de la Nage TV (2016)</strong>, <strong>Turma da Válvula (2021)</strong> e <strong>Luan's Revolution: Aftermath (2023)</strong>.
                </h2>
                <div className="pt-5 self-center animate__animated animate__fadeIn">
                  <button className="bg-cdln-blue-50 hover:bg-cdln-blue-100 text-cdln-blue-800 font-bold py-4 px-6 border-2 border-cdln-blue-400 rounded-3xl shadow-lg flex flex-row items-center gap-3 text-2xl" href="/">
                    <HiFilm size={30} />
              ...
              <img className="w-64 md:w-80 lg:w-96 self-center sm:block hidden" src={Shows} alt="Shows" />
            </div>
          </div>
        </div>
        {/* STORE */}
        <div class="py-44">
          <div className="store">
            <div className="flex flex-col sm:flex-row justify-center sm:justify-evenly p-4 sm:p-0">
              <img className="w-64 md:w-80 lg:w-96 self-center" src={Store} alt="Store" />
              <div className="flex flex-col gap-7">
                <h1 className="font-semibold text-5xl w-full md:text-7xl lg:text-8xl text-cdln-blue-100 text-center">Creme Store</h1>
                <h2 className="lg:text-3xl md:text-2xl text-lg justify-center text-slate-400 font-light text-center">
                Compre já nossos itens, camisetas, canecas e brinquedos do Creme de la Nage<br/>com frete grátis para todo o Brasil!
                </h2>
                <div className="pt-5 self-center animate__animated animate__fadeIn">
                  <button className="bg-cdln-blue-50 hover:bg-cdln-blue-100 text-cdln-blue-800 font-bold py-4 px-6 border-2 border-cdln-blue-400 rounded-3xl shadow-lg flex flex-row items-center gap-3 text-2xl" href="/">
