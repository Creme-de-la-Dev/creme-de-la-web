...
*/
function loadEverythingElse() {
	// Reset all game variables before starting
	setVariables();
	...
	// Update the night number display in the camera UI
	document.getElementById("timenightnumber").src = ("graphics/camera/ui/" + night + ".png");
	//} else {
